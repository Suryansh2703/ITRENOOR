      ...
      <nav className="fixed w-full z-50 bg-zinc-950/90 backdrop-blur-md border-b border-zinc-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/wishlist" aria-label="View Wishlist" className="relative text-zinc-200 hover:text-gold-400 transition-colors hidden lg:block">
            ...
            <Link to="/cart" aria-label="View Cart" className="relative text-zinc-200 hover:text-gold-400 transition-colors hidden lg:block">
          ...
          <div className="md:hidden flex items-center gap-4">
             ...
             <Link to="/wishlist" aria-label="View Wishlist" className="relative text-zinc-200 hover:text-gold-400 transition-colors">
              <Heart className="w-5 h-5" />
              {wishlistCount > 0 && (
             ...
             <Link to="/cart" aria-label="View Cart" className="relative text-zinc-200 hover:text-gold-400 transition-colors">
              <ShoppingBag className="w-5 h-5" />
              {itemCount > 0 && (
                <span className="absolute -top-2 -right-2 bg-gold-500 text-black text-[10px] font-bold w-4 h-4 rounded-full flex items-center justify-center">
                  {itemCount}
